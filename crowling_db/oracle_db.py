...
LOCATION = r'C:\oracle\instantclient_21_3'
os.environ["PATH"]=LOCATION + ';' + os.environ["PATH"]


# 사용자 정의 변수
dbURL = "192.168.219.108:1521/xe"
dbUSER = "c##homework"
dbPASSWD = "homework"

def oracle_init():  # 여러번실행하면 에러남 프로그램구동시 한번만 실행하도록만듦
    cx_Oracle.init_oracle_client(lib_dir="C:/Users/User/AppData/Local/Programs/Python/Python310")
