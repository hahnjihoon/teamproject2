...
from dinner_lunch_map import lunch_dbconn
#import dinner

lunch_dbconn.insertnews()
...
df = pd.read_csv('lunch.csv', encoding='euc-kr')
...
def show_marker_map(df):
    ...
    for n in df.index:
        ...
        if df['업종분류_1'][n] in type_list:
            ...
            icom_color = color_list[len(color_list)-1]
